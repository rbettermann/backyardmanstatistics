...
(function () {
  ...
  const ROWS = [
    ...
    { label: "Avg swim / loop", value: (a) => a.avg_swim, raw: (a) => a.avg_swim_seconds, better: "lower", when: "has_discipline_splits" },
    { label: "Avg bike / loop", value: (a) => a.avg_bike, raw: (a) => a.avg_bike_seconds, better: "lower", when: "has_discipline_splits" },
    { label: "Avg run / loop", value: (a) => a.avg_run, raw: (a) => a.avg_run_seconds, better: "lower", when: "has_discipline_splits" },
  ...
  function nameCell(athlete) {
    ...
    if (athlete.has_full_lap_metrics || athlete.lap_metrics_coverage) {
      ...
      badge.title = athlete.has_full_lap_metrics
        ? "Full supplementary (HR/cadence/pace) data available"
  ...
  const OVERLAYS = [
    ...
    { canvasId: "chart-swim", field: "swim_seconds", yLabel: "Swim time (min)", toMinutes: true },
    { canvasId: "chart-bike", field: "bike_seconds", yLabel: "Bike time (min)", toMinutes: true },
    { canvasId: "chart-run", field: "run_seconds", yLabel: "Run time (min)", toMinutes: true },
